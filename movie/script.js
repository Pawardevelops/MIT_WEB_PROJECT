...
for(var i=0;i<5;i++){
    genreListCompHolder.innerHTML += `<li class="mx-1">
    <div class="card d-flex justify-content-center align-items-center px-1">
        <p class="text-center ">${genre[i]["genre"]}</p>
  </div>
</li>`;
}
genreListCompHolder.innerHTML += `<a href="#" class="text-white text-outline-none">see more...</a>`
